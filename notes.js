...
function new_line(event) {
  ...
  next += '      <path d="M 15 2.5 l 0.5 7 l 4 0 l 0.5 -7 l -5 0 m 2.5 12.5 c -1.8 0, -2.0 -1.0, -2.0 -2.0 c 0 -1.8, 1.0 -2.0, 2.0 -2.0 c 1.8 0, 2.0 1.0, 2.0 2.0 c 0 1.8, -1.0 2.0, -2.0 2.0" id="' + n_lines + '.descriptor" class="descriptor option" fill="#33f"/>';
  next += '      ';
  ...
  next += '      <path d="M 24 4 h10 v10 h-10 v-10" class="dot option" id="' + n_lines + '.checkers"/>';
  next += '      <path d="M 25 7 L29 11 L35 1" class="check" id="' + n_lines + '.check" />';
...
function add_line(event) {
  ...
  next += '      <path d="M 15 2.5 l 0.5 7 l 4 0 l 0.5 -7 l -5 0 m 2.5 12.5 c -1.8 0, -2.0 -1.0, -2.0 -2.0 c 0 -1.8, 1.0 -2.0, 2.0 -2.0 c 1.8 0, 2.0 1.0, 2.0 2.0 c 0 1.8, -1.0 2.0, -2.0 2.0" id="' + boss + '.descriptor" class="descriptor option" fill="#33f"/>';
  next += '      ';
  ...
  next += '      <path d="M 24 4 h10 v10 h-10 v-10" class="dot option" id="' + boss + '.checkers"/>';
  next += '      <path d="M 25 7 L29 11 L35 1" class="check" id="' + boss + '.check" />';
